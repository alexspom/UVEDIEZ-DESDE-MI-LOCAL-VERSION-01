...
void v10menu2html(menus *m) 
{
	...
	do {
		...
		*miplantilla=0;
		...
		//función necesaria para mostrar el nombre real del usuario en el menú principal de la aplicación. Pibe.
		//<!--NOMBREREAL--> Inicio
		...
		v10htmlenviado=1;
		ret=v10htmlevento(NULL); // está en V10ev.c
	} while (ret==0);
}
