...
int main(int argc,char *argv[])
{
	...
	//El objetivo es obtener la fecha a partir de la cual borrar y entonces borrar ficheros más antiguos
	lHoras = atol(argv[1]);
	lNumDias=lHoras/24;   	        //Dias enteros
	lResto=lHoras%24;
	GetLocalTime(&st);
	//Normalización a un año
	st.wYear -=(lNumDias/365);		// Años a restar
	lNumDias = lNumDias % 365;	    // Normalizado a un año
