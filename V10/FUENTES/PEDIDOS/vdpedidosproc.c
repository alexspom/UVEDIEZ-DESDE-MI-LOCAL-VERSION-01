...
static int ejecutaalgoritmos(procesos *proceso,vdpedidocabs *pec) 
{
	...
	ret=VDEXECejecuta(proceso,pec,"#","%s#%s#%s#%s#%s#%s#%s#%s#%s#%s#%s#%s",pec->tipopedido,pec->coddiv,pec->codage,ag.grupoage,pec->codareaexped,spr.swtpickinginv,pec->backorder,spr.swtpickingagr,pec->swtmiscelaneo,pec->swtanular,pec->sufijodoc,pec->swtprepmono);  
    return(ret);   
}
