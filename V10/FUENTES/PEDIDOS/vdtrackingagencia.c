...
* VDTRACKINGAGENCIA.C
*                                                    
* Propósito: Procesos y algoritmos en C propios del tratamiento de asignación de tracking de agencia 
*                                            
* Autor  : RFD
* Fecha  : 25-09-2008                                                        
******
...
VDEXPORT int vdagenciasintracking(void *ptr,char *param) {
    ...
    if (nparam < 3) {
        v10log(LOGERROR,"vdagenciasintracking: Número de parámetros incorrecto, recibe %d necesita 3\n", nparam);
		return(0);
	}
