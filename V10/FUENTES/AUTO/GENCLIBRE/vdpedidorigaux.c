...
static diccols colvdpori[]={ 
    {"RETORNA",V10LONG,(size_t)&svdpori.retorna,sizeof(svdpori.retorna)},
    {"CODDIV",V10CADENA,(size_t)&svdpori.coddiv,sizeof(svdpori.coddiv)},
    {"ANOPED",V10LONG,(size_t)&svdpori.anoped,sizeof(svdpori.anoped)},
    {"CODPED",V10CADENA,(size_t)&svdpori.codped,sizeof(svdpori.codped)},
    {"SEQPED",V10LONG,(size_t)&svdpori.seqped,sizeof(svdpori.seqped)},
    {"SEQLINEA",V10LONG,(size_t)&svdpori.seqlinea,sizeof(svdpori.seqlinea)},
    {"STATUS",V10LONG,(size_t)&svdpori.status,sizeof(svdpori.status)},
    {"SECUENCIA",V10LONG,(size_t)&svdpori.secuencia,sizeof(svdpori.secuencia)}
    };
...
static void init_selvalpedidorigcab(void)
{
    ...
    for(nc=0;nc<dvdpori[0].numcol;nc++) dvdpori[0].c[nc].offset-=(size_t)&svdpori;
