...
CAMPO=CODARTLEIDO,SCAN,OCULTO,"_20_"
#,POSTCHANGE=FEJECUTA(FFUERZASCAN("ART"),"\nERROR\n DEBE SCANNEAR\n EL ARTICULO")
CAMPO=CODLOTLEIDO,OCULTO,"_40_"
#CAMPO=CODBARRAS1,SCAN,POSTCHANGE=FDESIGNACION(FIF("CSELNOTNULL",FPOSICIONABLOQUE("VDMOVSTKPARCIALORI.PAN"),FSUCCESS),"",
...
CURSOR=CSELARTNOTNULL SELECT :CODARTLEIDO FROM DUAL WHERE :CODARTLEIDO IS NOT NULL;
