...
CAMPO=CODMAT,SCAN,AUTOENTER,POSTCHANGE=FEJECUTA("CELIMINACEROS","",
...
CURSOR=CELEMINACEROS SELECT CASE WHEN LENGTH(:CODMAT)=20 THEN SUBSTR(:CODMAT,3) ELSE :CODMAT END CODMAT FROM DUAL;		   
