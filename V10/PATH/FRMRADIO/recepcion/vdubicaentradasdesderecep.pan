...
CAMPO=CODUBIDEST,NOENTER,OCULTO,"_______________"
...
CURSOR=CSELCODUBIDEST SELECT CODUBIDEST,VDCLIPKG.PINTAUBICA(CODUBIDEST) PINTACODUBIDEST,MOV.CODART,CANTIDAD,ART.UNIEMB,FLOOR(CANTIDAD/ART.UNIEMB) CAJAS,MOD(CANTIDAD,ART.UNIEMB) PICO,ART.DESART
