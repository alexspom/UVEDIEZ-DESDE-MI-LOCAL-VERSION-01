...
WFRAME(15,12,178,0,"Series","")
WFRAME(410,12,280,0,"Bultos","")
...
PREUPDATE=FEJECUTA("@CCHECKIMPRIMIR","",
  ...
  FEJECUTA("+CSELNOMBREALB","",
            FIMPRIME("INFORME",":NOMBREALB","CODDIV=:CODDIV;ANOPED=:ANOPED;CODPED=:CODPED;SEQPED=:SEQPED","",":NUMALBA"),":V10ERROR")),"ERROR EN FIF CSELNUMALBA",
                                   FIF("CSELPROFORMA",
                                       FIF("CSELSWTPROFORMA",
                                          FEJECUTA(FIMPRIME("INFORME","VDFACTURAPROFORMA.RPT","FORMCODDIV=:CODDIV;FORMANOPED=:ANOPED;FORMCODPED=:CODPED;FORMSEQPED=:SEQPED","",":NUMFAC")
                                          ,":V10ERROR"), FSUCCESS),"ERROR EN FIF CSELSWTPROFORMA"
...
POSTCOMMIT=FEJECUTA(FCOMMIT,"",
                    "+CSELNUMBOL","",
                     FIMPRIME("INFORME","$(VDBOLETA)","CODBOLETA=:CODBOLETAAUX;ANOBOLETA=:ANOBOLETAAUX;FORMCOPIA='N';",""),":V10ERROR",
                    +FBORRAFORM,"")

CAMPO=CODAGE,VIRTUAL,OCULTO
CAMPO=CODSERIEEXP,NOENTER,TOOLTIP("Código de la serie de expedición"),TITULO("Expedición")
CAMPO=CODSERIEPREP,NOENTER,TOOLTIP("Código de la serie de preparación"),TITULO("Preparación")
CAMPO=DESSERIE,NOENTER,TITULO("Descripción")
CAMPO=NUMPEDIDOS,AUXILIAR,NOENTER,TOOLTIP("Número de pedidos de las series finalizadas"),TITULO("Pedidos")
CAMPO=BULTOSPAL,AUXILIAR,NOENTER,TOOLTIP("Número de bultos de palet de las series finalizadas"),TITULO("Palets")
CAMPO=BULTOSCAJ,AUXILIAR,NOENTER,TOOLTIP("Número de bultos de caja completa de las series finalizadas"),TITULO("Cajas")
CAMPO=BULTOSUNI,AUXILIAR,NOENTER,TOOLTIP("Número de bultos de unidades de las series finalizadas"),TITULO("Unidades")
...
CURSOR=CPONDATOS SELECT :CODBOLETAAUX CODBOLETA,:ANOBOLETAAUX ANOBOLETA,
                        ...
                        VD.HORASYS HORAMODIF,VDST.FSEXIMPRESA STATUS
                   FROM DUAL;
