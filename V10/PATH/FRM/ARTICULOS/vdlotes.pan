...
CURSOR=CIMPREETIQ DECLARE
                  ...
                  BEGIN
                    SELECT UNIEMB INTO MIUNIEMB FROM VDARTIC WHERE CODART=:CODART;
...
#VDIMPRE.SPOOL(VDUSER.GETHOSTNAME,'ETIQ','','','VDPRODUCTO.GEN;VDETIQUETAS.VSQ;PRODUCTO','CODART='||:CODART||';CODLOT='||:CODLOT||';UNIEMBHOST='||MIUNIEMB||';TIPOEMBA=''CAJA'';ESCOPIA=''S''',1,0,'',50,:RET);
