###################################################################
#Módulo: VDBULANULPEND.PAN
#Funcionalidad : Anulación de cantidades pendientes de servir
#Autor: JMM      
#Fecha: 04-07-2008
###################################################################
# Histórico de cambios:
ANULACION DE CANTIDADES PENDIENTES DE SERVIR
Línea    Artículo                              Lote            A servir       Regularizar     Unids.  Estado                   Ultima modificación              
...
PREUPDATE=FEJECUTA("CCHECKCANTIDAD","LA CANTIDAD A REGULARIZAR NO PUEDE SER MAYOR QUE LA PENDIENTE DE SERVIR",
                  ...
                  +FCOMMIT,"",
                   %FFAILURE,"ANULACION REALIZADA CON ÉXITO")
...
CAMPO=DESSTATUS,UPPER,AUXILIAR,NOENTER,TOOLTIP("Descripción del estado")
