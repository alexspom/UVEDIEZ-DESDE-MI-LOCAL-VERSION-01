...
POSY = 7	
  ...
  TITULO=DATOS DE INCIDENCIAS FACTURADAS
...
PADRE = VDINFINCIFACT.PAN
  TECLA = SF8, FEJECUTA(FIMPRIME("INFORME","HOJA DE FACTURACION DE INCIDENCIAS.RPT","FORMCODCLI=:CODCLIENTE;FORMFECINI=:FECININUMERICO;FORMFECFIN=:FECFINNUMERICO;FORMSTATUS=500","WINVIEW"),":V10ERROR")
  BOTON = IMPRIMIR,780,20,50,50,"Imprimir factura",fileprint.png,SF8,"Imprimir",INCLUDECSS="background-color: transparent;border-width:0px"
  TECLA = SF10, FEJECUTAFORM ("VDINCIDENCIAS", "S","CODINCI=:CODINCI","","DATOS DE LA INCIDENCIA :CODINCI")
