...
DATOS DE CABECERA DE INCIDENCIA
  ...
  Incidencia: @L@@@@@@@       Núm. incidencia cliente: __________

  

    Pedido:    _20_________  Cliente: _20_______ _________________________________ 
    División:  _4__  _40_____________________________________                
...
################################################### DATOS TECNICOS ################################################### 
CAMPO=CODPED,NOENTER,TOOLTIP("Código del pedido"),TITULO("ALBARAN")
...
CAMPO=CODDIV,NOENTER,TOOLTIP("Division o compañia del pedido"),POSTCHANGE=FDESIGNACION("+CDESDIV","Código de división no existe.")
CAMPO=DESDIV,AUXILIAR,NOENTER
CAMPO=CODAGE,NOENTER,TOOLTIP("Es el código de la agencia que transportará el pedido. Deberá existir en la tabla de agencias"),POSTCHANGE=FDESIGNACION("CDESAGE","Agencia no existe.")
...
TECLA = F8, FEJECUTA ("CVERIFICACAUSA", " Por favor, indique la causa de la incidencia... ",
                      "CSELVERIFSOLUCION", " Por favor, informe la solución... ",
					            "CVERIFICAFACTURA", " La incidencia es facturable \n Por favor, indique los datos de facturación.  ",
...
#                       "CINSERTALINEAASIGNA", " No puedo insertar línea de incidencia",
