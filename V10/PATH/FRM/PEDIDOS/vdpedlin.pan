...
LINEAS DE PEDIDO
Sec      Artículo                        Lote      Uni Pedida      A servir    Servida.    Status IVA    Recar. Dcto   Precio        Uds.Precio P B C M R Expositor       Marca stk.    NºSerie   Comentario Ultima modificación           VDExtra
@L@@@@@@ _40_______ _40_________________ _40______ _10 #L#,###,### #L#,###,### #L#,###,### @L@@@  #L#.## #L#.## #L#.## #L#,###,#.### _10______  _ _ _ _ _ _20____________ _60__________ _60______ @L@@@@@@@   _32_______ ¿D-MM-YY ________  __250____
|
...
CAMPO=UNIDADESPRECIO,WLONX=20,TOOLTIP("Unidades del precio."),TITULO("Uds. Precio")
...
CAMPO=NUMEROSERIE,WLONX=20,TOOLTIP("Número de serie de la mercancía"),TITULO("Núm Serie")
