...
CAMPO=DESAGE,AUXILIAR,NOUPDATE,TOOLTIP("Es la descipción de la agencia dee transporte para el pedido."),TITULO("Ruta"),WLONX=25
CAMPO=PICOS,AUXILIAR,NOUPDATE,TOOLTIP("Número de restos del pedido"),TITULO("Lin.")
CAMPO=UNIDADES,AUXILIAR,NOUPDATE,OCULTO,"@L@@@@@"
CAMPO=BULTOSU,AUXILIAR,NOUPDATE,TOOLTIP("Número de restos del pedido"),TITULO("Lin.")
CAMPO=CAJAS,AUXILIAR,NOUPDATE,TOOLTIP("Número de cajas aproximadas del pedido"),TITULO("Caj.")
CAMPO=PALETS,AUXILIAR,NOUPDATE,TOOLTIP("Número de palets aproximados del pedido"),TITULO("Tar.")
