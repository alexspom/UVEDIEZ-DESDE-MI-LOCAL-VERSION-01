...
BEGINBLOQUE=VDLOTES.PAN
 ...
 CAMPO=DUMMY,AUXILIAR,OCULTO,"@"
  ...
  TECLA=SF8,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD_STD.rpt","CODART=:CODART;CODLOT=:CODLOT;CODCONCE=NULL;FECDESDE='01-01-01';FECHASTA='01-01-90'",""),":V10ERROR")
  TECLA=SF9,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD_STD.rpt","CODART=:CODART;CODLOT=:CODLOT;CODCONCE='PEDEXPED';FECDESDE='01-01-01';FECHASTA='01-01-90'",""),":V10ERROR")

#TECLA=SF10,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD_ABREV.RPT","CODART=:CODART;CODLOT=:CODLOT;CODCONCE='';FECDESDE='01-01-01';FECHASTA='31-12-90'",""),":V10ERROR")
#TECLA=SF11,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD_ABREV.RPT","CODART=:CODART;CODLOT=:CODLOT;CODCONCE='PEDEXPED';FECDESDE='01-01-01';FECHASTA='31-12-90'",""),":V10ERROR")

  TECLA=SF11,FEJECUTA("CSELBINDNONULO","INFORME ARTICULO Y LOTE",
                     "CDAMESELECT","",
                     FSQL2EXCEL(":MIQUERY","","0","1",""),"")    

  BOTON=B1,900,45,70,70,"IMPORTAEXCEL",EXCEL02.png,SF11,"Exportar a Excel",INCLUDECSS="background-color:transparent;border-width:0px"
  
  BOTON=B2,900,145,70,70,"IMPORTAPDF1",pdffiles01.png,SF8,"Informe Trazabilidad Completo",INCLUDECSS="background-color:transparent;border-width:0px"

#BOTON=B3,900,95,80,80,"IMPORTAPDF2",pdf-files02.png,SF9,"Informe Trazabilidad Pedidos",INCLUDECSS="background-color:transparent;border-width:0px"

  
 CURSOR=CSELBINDNONULO SELECT 1 DUMMY FROM DUAL WHERE :CODART IS NOT NULL AND :CODLOT IS NOT NULL; 
 ...
 CURSOR=CDAMESELECT SELECT 'SELECT ART.CODDIV DIVISION, '||'
                                     ...
                                     WHERE MOV.CODMOV     = BUL.CODMOVEXP(+) '||'
                                       ...
                                       AND MOV.CODLOT=NVL('''||:CODLOT||''', MOV.CODLOT) '||'
...
BEGINBLOQUE=VDENTSALXART.PAN
  ...
  CURSOR=CCALCSTOCK  SELECT NVL(SUM(CANTIDAD),0) STOCKACTUAL FROM VDSTOCK WHERE CODART=:CODART AND CODLOT=:CODLOT; 
...
#TECLA=SF8,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD.rpt","CODART=:CODART;CODLOT=:CODLOTAUX;CODCONCE='';FECDESDE='01-01-01';FECHASTA='31-12-90'",""),":V10ERROR")
#TECLA=SF9,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD.rpt","CODART=:CODART;CODLOT=:CODLOTAUX;CODCONCE='PEDEXPED';FECDESDE='01-01-01';FECHASTA='31-12-90'",""),":V10ERROR")
# TECLA=SF10,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD_ABREV.RPT","CODART=:CODART;CODLOT=:CODLOTAUX;CODCONCE='';FECDESDE='01-01-01';FECHASTA='31-12-90'",""),":V10ERROR")
# TECLA=SF11,FEJECUTA(FIMPRIME("INFORME","VDTRAZABILIDAD_ABREV.RPT","CODART=:CODART;CODLOT=:CODLOTAUX;CODCONCE='PEDEXPED';FECDESDE='01-01-01';FECHASTA='31-12-90'",""),":V10ERROR")
ONLINE={May+F8} Imprime Listado Trazabilidad {May+F9} Imprime Listado Expediciones;   
