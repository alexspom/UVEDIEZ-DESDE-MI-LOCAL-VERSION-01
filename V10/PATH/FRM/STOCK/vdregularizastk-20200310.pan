...
REGULARIZACIONES DE STOCK DESDE PANTALLAS
   ...
   Ubicación: ____________ __________   
   Matrícula: __________________    
   Orden Stk: @@@@@@@@@ 
                                                                              
   Artículo:  _40___________________  _100______________________________________
...
CURSOR=CREGULARIZA BEGIN
                    VDPICKINV.REGULARIZASTKPINV(:CODMAT,:ORDENSTK,:CODCONCE,:UBICODCONCE,:DIFF,:OBSERV,:CODMOVOUT,'EXP',:MSJERROR,:RET);
                   END;@
