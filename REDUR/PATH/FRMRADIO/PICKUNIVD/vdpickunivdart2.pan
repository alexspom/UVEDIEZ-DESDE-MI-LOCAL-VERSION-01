...
POSTQUERY=FEJECUTA(FIF("CSELNULL",FPOSICIONABLOQUE("VDPICKUNIVDANUL.PAN"),FSUCCESS),"\n\n ERROR\n CARGANDO BLOQUE\n VDPICKUNIVDANUL.PAN",                   
                   "CVERIFART","\n\n ERROR\n ARTICULO INCORRECTO",
                   "CVERIFLOTE","\n\n ERROR\n LOTE INCORRECTO",
				   FPOSICIONABLOQUE("VDPICKUNIVDART.PAN"),"\n\n ERROR\n CARGANDO SIGUIENTE\n BLOQUE")
...
CAMPO=CODBARRAS,SCAN,AUTOENTER,POSTCHANGE=FEJECUTA(FIF("CSELNULL",FPOSICIONABLOQUE("VDPICKUNIVDANUL.PAN"),FSUCCESS),"\n\n ERROR\n CARGANDO BLOQUE\n VDPICKUNIVDANUL.PAN",
