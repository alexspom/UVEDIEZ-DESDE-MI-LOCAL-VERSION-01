...
PREQUERY=FEJECUTA(FIF("CSELPICKPDTE",FPOSICIONABLOQUE("VDPICKUNIVDUBI.PAN"), FSUCCESS),"\n\n ERROR EN CSELPICKPDTE",
                  FIF("CMOVTOSPDTESTOCK",FPOSICIONABLOQUE("VDPICKUNIVDPDTESTOCK.PAN"),
                                         FPOSICIONABLOQUE("VDPICKUNIVDNOPICK.PAN")), "\n\n ERROR EN CMOVTOSPDTESTOCK") 
...
CURSOR=CSELPICKPDTE SELECT MOV.CODMOV, MOV.CODART, 
                     ...
                     WHERE LB.CODBULTO=:CODBULTO
                       ...
                       AND MOV.TAREA LIKE VD.GETPROP('TAREAPEDUNI')||'%'
