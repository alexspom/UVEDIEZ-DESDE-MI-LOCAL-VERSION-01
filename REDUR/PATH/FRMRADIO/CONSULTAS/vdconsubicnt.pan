...
OPCION _ (0) ANTERIOR
         ...
         (3) INVENTARIO
|
PREQUERY=FEJECUTA(FIF("CSELMAT",FSUCCESS,FPOSICIONABLOQUE("VDCONSUBI.PAN")),"NO HAY STOCK EN LA UBICACION",
                  "CLIMPIASTK","",
                  "+CCARGAPREASIG","",
...
CAMPO=CODAREA,NOENTER,OCULTO,"_20"
...
CURSOR=CREAINVEN DECLARE
                 ...
                 BEGIN
                  ...
                  MICODINVEN:=SMINVEN.CREAINVENDIARIO('CONSULTA');
