...
Orden  Artículo       Designación                  Recepcion     Orden rec       Cantidad  Ultima modificación              Uni/emb E/con Bloqueos   Tipo     Precio        Extra           Coment.
@L9@@@ _40___________ _100________________________ _40__________ _80____________ #L15##### _32________ ¿D-MM-Y.YY  ________ #L15### #L### __________ _10_____ #L12#####.### _255___________ @L@@@@@@@
|
TABLA=VDSTOCK
ORDERBY=ORDENSTK;
#
...
CAMPO=ORDRECEP,AUXILIAR,NOUPDATE,TITULO("Orden")
