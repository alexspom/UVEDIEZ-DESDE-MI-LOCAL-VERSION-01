...
CURSOR=CSELBULTO SELECT CODBULTO FROM VDBULTOCAB WHERE (CODDIV = 'BEL' AND MATCAJA=:MATCAJA AND STATUS<=VDST.FBUCAETIQUETAR) OR (CODDIV <> 'BEL' AND CODBULTO = :MATCAJA)/*
                  UNION
                 SELECT BUC.CODBULTO 
