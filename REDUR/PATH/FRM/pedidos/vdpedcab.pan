...
CABECERA DE PEDIDO
 ...
 ³ Año Agrup.: @@@@                  Pedido Cliente: _60_____________      Fecha Ent. Concertada: ¿D-MM-Y.YYY              ³ 
 ³ Agrupación: @@@@@@@@              Fecha:          ¿D-MM-Y.YYY           Fecha Ent. Límite:     ¿D-MM-Y.YYY              ³ 
 ...
 ³    Población: _40_____________________ Provincia: _____ _40_______________ DP: __________   País: ____ _30_____________ ³
 ...
 ³  Peso: #L,##########.## Kg Volúmen: #,L############.## m3 Prec. bultos: @@@@ Recargo: @@@@@@@                           ³
 ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ 
...
CAMPO=FECENTLIMITE,TOOLTIP("Fecha ent límite")
...
CAMPO=CODPAIS,TOOLTIP("Pais de envio"),POSTCHANGE=FDESIGNACION("CDESPAIS","País no existe."),COMBOX("CSELPAISES")
...
CAMPO=COLCAMBIOVOL,TOOLTIP("Colección de volumetrias de sustitución para el pedido."),COMBOX("CSELCOLCAMBIOVOL"),POSTCHANGE=FEJECUTA("CVERCOLCAMBIOVOL","No existe cambio de volumetria")
...
CAMPO=SWTNOETIQCC,UPPER,POSTCHANGE=FVERIFICA("SN","Los posibles valores son S(i) N(o)"),TOOLTIP("Indicador que puede tomar los siguientes valores: 'S' indica que no se deben imprimr etiquetas de caja completa (fuerza preparación monopedido) o 'N' se imprimen etiquetas de caja completa normalmente."),CHECKBOX("N","S"),OCULTO,"_"
CAMPO=CODAGE,TOOLTIP("Es el Código de la agencia que transportará el pedido. Deberá existir en la tabla de agencias"),POSTCHANGE=FDESIGNACION("CDESAGE","Agencia no existe."),COMBOX("CLISTAAGE")
...
CAMPO=PRECNBULTOS,AUXILIAR,TOOLTIP("Precáculo del número de bultos que tendrá el pedido")
...
CAMPO=ALBARAN,NOUPDATE,AUXILIAR,OCULTO,"_60_"
...
CURSOR=CSELALBARAN SELECT 'd:\v10\redur\path\informes\vdalbaran#ERDR#DARRWLFR.jasper' ALBARAN, 'http://130.61.61.46:5201/pdf/'||:CODPED||'.PDF' RUTA
                     FROM DUAL;
...
BOTON=B1,915,50,70,70,"P",miimprimir.png,F10,"Impresión del Albarán",INCLUDECSS="background-color: transparent;border-width:0px"
BOTON=B3,920,150,60,60,"P",mipdf.png,SF11,"Exportar el albarán a PDF",INCLUDECSS="background-color: transparent;border-width:0px"
...
BOTON=B3,920,350,60,60,"P",mizoom.png,SF10,"Menú de zoom",INCLUDECSS="background-color: transparent;border-width:0px"
