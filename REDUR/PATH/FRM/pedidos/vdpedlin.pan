...
LINEAS DE PEDIDO
Sec      Artículo                        Lote            Caduci.  Caj  Pedida      Uni. A servir    Servida.    Status               P B C M R Comentario Ultima modificación           VDExtra
...
CAMPO=STATUS,TOOLTIP("Estado de la línea de pedido según tabla de estados tipo LP"),TITULO("Estado"),WLONX=20,POSTCHANGE=FDESIGNACION("+CDESCRSTATUS",""),COMBOX("CSTATUS")
