...
LINEAS DE PEDIDO MANUAL
 Sec      Artículo                                           Pedida    Extra  Lote             Serie             Precio        IVA    Recar. Dcto     Ultima modificación
 @L@@@@@@ _40_________________ _100_________________________ #L15##### _255__ _10_____________ _2000____________ #L#,###,#.### #L#.## #L#.## #L#.##  _32_______ ¿D-MM-YY ________
|
...
CAMPO=CODART,UPPER,TOOLTIP("Es el código del artículo a servir"),
        POSTCHANGE=FDESIGNACION("CDESART","Articulo no encontrado"),TITULO("Articulo"),WLONX=20
#,COMBOX("CLISTAART")
...
CURSOR=CINITDATOS SELECT VDST.FPELASERVIR STATUS,
                        ...
                        (SELECT MAX(SEQLINEA)+1 FROM VDPEDIDORIGLIN WHERE CODPED = :CODPED) SEQLINEA,
                         'E' BACKORDER, 'N' TIPOREDONDEO, UNIDADESHOST,
                         'M' OPCIONPRECIO, UNIDADESHOST UNIDADESPRECIO
                    FROM VDARTIC
					WHERE CODART = :CODART;
