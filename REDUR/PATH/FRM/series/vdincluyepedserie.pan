...
PEDIDOS PENDIENTES DE INCLUIR EN SERIE
 Pedido           Albaran  P. Tipo F.entrega  DP       Consignatario                                            Ruta             Mono Agencia   \Lin\Uni.\Caj.\Pal.  Inc.
 _20_ _20________ _20_____ ## ____ ¿D-MM-Y.YY _20_____ _12____ _40_______________ _40__________ _40____________ _40______________ _    _30_____  @@@@ @@@@ @@@@ @L@@@  _ 
|
...
PREUPDATE=FEJECUTA("CSELSIHAYSERIE","NO HA CREADO UNA SERIE DONDE INCLUIR LOS PEDIDOS",
				   ...
				   "CUPDDESCSERIE","Error actualizando nombre de la serie con ruta",
...
CAMPO=CODRUTAAUX,VIRTUAL,AUXILIAR,NOUPDATE,OCULTO

CAMPO=CODDIV,NOUPDATE,TITULO("Div.")
CAMPO=CODPED,NOUPDATE,TOOLTIP("Código del pedido"),POSTCHANGE=FDESIGNACION("+CINCLUIR","NO PUEDO INCLUIR","CSELDATOS","","+CSELRUTA",""),TITULO("Pedido")
CAMPO=CODALB,NOUPDATE,TOOLTIP("Albaran"),TITULO("Albaran")
...
CAMPO=FECRECEP,TITULO("Recibido"),WLONX=5,OCULTO,"¿D-MM-Y.YY"
...
CAMPO=CODRUTA,AUXILIAR,NOUPDATE
...
CAMPO=SWTPREPMONO,NOUPDATE,TITULO("Mono."),WLONX=12
...
CURSOR=CSELDATOS SELECT UNIDADES,LINEAS PICOS,BULTOSU,BULTOSC CAJAS,BULTOSP PALETS
...
CURSOR=CUPDDESCSERIE UPDATE VDSERIEPREP SET DESSERIE=DESSERIE||' - RUTA '||:CODRUTAAUX 
                      WHERE CODSERIEPREP=:CODSERIEPREP AND :CODRUTAAUX IS NOT NULL AND
					        NVL(INSTR(DESSERIE,'RUTA'),0)=0;
